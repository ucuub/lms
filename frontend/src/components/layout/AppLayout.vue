<template>
  <div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    <!-- Sidebar -->
    <aside :class="[
      'fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 flex flex-col shrink-0 transition-transform duration-200',
      'lg:relative lg:translate-x-0',
      sidebarOpen ? 'translate-x-0' : '-translate-x-full'
    ]">
      <!-- Logo -->
      <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
        <RouterLink to="/" class="flex items-center gap-2" @click="sidebarOpen = false">
      ...
      <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <RouterLink to="/courses" class="sidebar-link" @click="sidebarOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
          Kursus
        </RouterLink>

        <RouterLink to="/calendar" class="sidebar-link" @click="sidebarOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
          Kalender
        </RouterLink>

        <RouterLink to="/notifications" class="sidebar-link" @click="sidebarOpen = false">
          <div class="relative">
        ...
        <RouterLink to="/practice" class="sidebar-link" @click="sidebarOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
          Practice Quiz
        </RouterLink>

        <RouterLink to="/ujian" class="sidebar-link" @click="sidebarOpen = false">
        ...
        <template v-if="auth.isTeacher">
          ...
          <RouterLink to="/courses/create" class="sidebar-link" @click="sidebarOpen = false">
          ...
          <RouterLink to="/ujian/create" class="sidebar-link" @click="sidebarOpen = false">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            Buat Ujian
          </RouterLink>
          <RouterLink to="/ujian-wajib" class="sidebar-link" @click="sidebarOpen = false">
        ...
        <template v-if="auth.isAdmin">
          ...
          <RouterLink to="/admin" class="sidebar-link" @click="sidebarOpen = false">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
            Dashboard Admin
          </RouterLink>
          <RouterLink to="/admin/users" class="sidebar-link" @click="sidebarOpen = false">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            Manajemen User
          </RouterLink>
          <RouterLink to="/admin/courses" class="sidebar-link" @click="sidebarOpen = false">
